...
2. Also read `docs/project-brief.md` before coding, because it's the official project brief and grading criteria; treat it like the rubric (it wins on conflicts alongside SPEC_CHECKLIST.md).
...
- `.cursor/rules/`: file-scoped rules, namely `core`, `rust-engine`, `scoring-honesty`, `ai-traceability`, `testing-evals`, `sync`.
